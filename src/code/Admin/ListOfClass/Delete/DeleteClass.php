...
<p><strong><h1><center>Страница с удалением</center></strong></h1></p>
<center><img src="../../../../materials/images/delete.png" width="70" height="70" ></center><h1></h1>
<?php
$conn_id=new mysqli('mysql', 'user', 'password', 'school') or exit ();
$flag=0;
echo "<table border=0 cellpadding=5 cellspacing=5 align=center>";
echo "<tr align=center valign=middle bgcolor=#2d5787 style='color:#ffffff'><td>Класс</td><td>Буква</td><td>Фамилия</td><td>Имя</td><td>Отчество</td><td>Удаление</td></tr>"; 
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td><a href='./ProcessDeleteClass.php?id_counter=".$row['id_counter']."'>Удаление</a></td>";
	echo "</tr>";
}
echo "</table>"; 

<html>
<head>
<title>Успеваемость 2-ого полугодия</title>
<link href="../../../../materials/icon/schoolicon.ico" rel="icon" type='mage/x-icon'>
</head>
<body bgcolor='white'>
<p><strong><h1><center>Страница с успеваемостью 2-ого полугодия</center></strong></h1></p>
<?php
...
$result = mysqli_query($conn_id, "SELECT DISTINCT academicyear.name_year, schoolchild.id_class, schoolchild.id_character,schoolchild.surname,schoolchild.first_name,schoolchild.second_name FROM schoolchild  LEFT JOIN academicrecord ON schoolchild.id_schoolchild = academicrecord.id_schoolchild LEFT JOIN academicyear ON academicrecord.id_academicyear = academicyear.id_academicyear WHERE ((academicrecord.id_schoolchild =$id) AND (academicrecord.id_academicyear=1))") or exit ();

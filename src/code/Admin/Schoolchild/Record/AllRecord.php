...
<center>
<img src="../../../../materials/images/record.png" width="100" height="100">
</center>
<?php $id = (int)$_GET['id_schoolchild'];
echo "<p><h3><center><img src='../../../../materials/images/add.png' width='20' height='20' ><a href='../Add/AddRecord.php?id_schoolchild=".$id."'>Добавление</a>&nbsp <img src='../../../../materials/images/change.png' width='20' height='20' ><a href='../Modification/RecordForChange.php?id_schoolchild=".$id."'>Обновление</a> &nbsp <img src='../../../../materials/images/delete.png' width='20' height='20' ><a href='../Delete/DeleteRecord.php?id_schoolchild=".$id."'>Удаление</a></center></h3></p>";

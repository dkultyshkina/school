...
if ($class == "11") {
	...
	echo "<li><h3><center><a href='./Record/AllRecord.php?id_schoolchild=".$id."'>Общая успеваемость</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/FirstHalfOnTheYearRecord.php?id_schoolchild=".$id."'>Справка успеваемости по 1 полугодию</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/SecondHalfOnTheYearRecord.php?id_schoolchild=".$id."'>Справка успеваемости по 2 полугодию</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/YearRecordHalfOfYear.php?id_schoolchild=".$id."'>Справка успеваемости Годовые оценки</a></center></h3></li> ";
	
} else if ($class == "9") {
	echo "<li><h3><center><a href='./Record/AllRecord.php?id_schoolchild=".$id."'>Общая успеваемость</a></center></h3>";
	echo "<li><h3><center><a href='./Record/FirstQuaterRecord.php?id_schoolchild=".$id."'>Справка успеваемости по 1 четверти</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/SecondQuaterRecord.php?id_schoolchild=".$id."'>Справка успеваемости по 2 четверти</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/ThirdQuaterRecord.php?id_schoolchild=".$id."'>Справка успеваемости по 3 четверти</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/FourthQuaterRecord.php?id_schoolchild=".$id."'>Справка успеваемости по 4 четверти</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/YearRecordQuater.php?id_schoolchild=".$id."'>Справка успеваемости Годовые оценки</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/ExamRecord.php?id_schoolchild=".$id."'>Справка успеваемости Экзаменационные оценки</a></center></h3></li>";
	echo "<li><h3><center><a href='./Record/ResultRecord.php?id_schoolchild=".$id."'>Справка успеваемости Итоговые оценки</a></center></h3></li>";
} else {
	echo "<li><h3><center><a href='./Record/AllRecord.php?id_schoolchild=".$id."'>Общая успеваемость</a></center></h3> ";
	echo "<li><h3><center><a href='./Record/FirstQuaterRecord.php?id_schoolchild=".$id."'>Справка успеваемости по 1 четверти</a></center></h3></li> ";
	echo "<li><h3><center><a href='./Record/SecondQuaterRecord.php?id_schoolchild=".$id."'>Справка успеваемости по 2 четверти</a></center></h3></li> ";

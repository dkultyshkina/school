...
<p><strong><h1><center>Удаление успеваемости</center></strong></h1></p>
...
echo "<tr align=center valign=middle bgcolor=#2d5787 style='color:#ffffff'><td>Фамилия</td><td>Имя</td><td>Предмет</td><td>Название оценки</td><td>Оценка</td><td>Удаление</td></tr>"; 
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td>".$row['mark']."</td>";
	echo "<td><a href='ProcessDeleteRecord.php?id_academicrecord=".$row['id_academicrecord']."'>Удаление</a></td>";
	echo "</tr>";
}
echo "</table>"; 

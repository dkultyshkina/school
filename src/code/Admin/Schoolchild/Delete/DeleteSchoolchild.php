<html>
<head>
<title>Удаление информации о школьниках</title>
...
<p><strong><h1><center>Удаление информации о школьниках</center></strong></h1></p>
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td><a href='./ProcessDeleteSchoolchild.php?id_schoolchild=".$row['id_schoolchild']."'>Удаление</a></td>";	
	echo "</tr>";
}
echo "</table>"; 

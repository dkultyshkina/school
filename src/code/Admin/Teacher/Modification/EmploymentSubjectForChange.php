...
echo "<tr align=center valign=middle bgcolor=#2d5787 style='color:#ffffff'><td>id учитель</td><td>Фамилия</td><td>Имя</td><td>Отчество</td><td>Класс</td><td>Буква</td><td>Предмет</td><td>Обновление</td></tr>"; 
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td><a href='ModificationEmploymentSubject.php?id_teaching=".$row['id_teaching']."&id_teacher=".$row['id_teacher']."'>Изменить</a></td>";
}
echo "</table>"; 

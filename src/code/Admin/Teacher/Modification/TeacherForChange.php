<html>
<head>
<title>Изменение ифнормации об учителях</title>
...
<p><strong><h1><center>Изменение информации об учителях</center></strong></h1></p>
...
echo "<tr align=center valign=middle bgcolor=#2d5787 style='color:#ffffff'><td>id Учитель</td><td>Фамилия</td><td>Имя</td><td>Отчество</td><td>Классное руководство</td><td>Номер телефона</td><td>Дата рождения</td><td>Изменить информацию</td></tr>"; 
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td><a href='ModificationTeacher.php?id_teacher=".$row['id_teacher']."'>Изменение</a></td>";	
	echo "</tr>";
}
echo "</table>"; 

...
<h1> </h1>
<p><strong><h1><center>Удаление занятости учителя</center></strong></h1></p>
<center><img src="../../../../materials/images/delete.png" width="70" height="70" ></center>
...
echo "<tr align=center valign=middle bgcolor=#2d5787 style='color:#ffffff'><td>id учитель</td><td>Фамилия</td><td>Имя</td><td>Отчество</td><td>Класс</td><td>Буква</td><td>Предмет</td><td>Удаление</td></tr>"; 
$id = (int)$_GET['id_teacher']; 
$query="SELECT teacher.id_teacher, teacher.Surname, teacher.First_name, teacher.Second_name,teaching.id_teaching, teaching.id_class, teaching.id_character, subject.name_subject FROM teacher LEFT JOIN school.teaching ON teacher.id_teacher = teaching.id_teacher  LEFT JOIN school.subject ON teaching.id_subject = subject.id_subject WHERE  teacher.id_teacher = $id";
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td><a href='ProcessDeleteEmploymentSubject.php?id_teaching=".$row['id_teaching']."&id_teacher=".$row['id_teacher']."'>Удаление</a></td>";
}
echo "</table>"; 

...
echo "<tr align=center valign=middle bgcolor=#2d5787 style='color:#ffffff'><td>id учитель</td><td>Фамилия</td><td>Имя</td><td>Отчество</td><td>Класс</td><td>Буква</td><td>Удаление</td></tr>"; 
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td><a href='ProcessDeleteEmploymentClass.php?id_counter=".$row['id_counter']."'>Удаление</a></td>";
}
echo "</table>"; 

...
echo "<tr align=center valign=middle bgcolor=#2d5787 style='color:#ffffff'><td>id Предмета</td><td>Название предмета</td><td>Удаление</td></tr>"; 
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td><a href='./ProcessDeleteSubject.php?id_subject=".$row['id_subject']."'>Удаление</a></td>";	
	echo "</tr>";
}
echo "</table>"; 

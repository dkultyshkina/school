...
<li><a href="../../Subject/Subject.php">Предметы</a></li>
<li><a href="../../../../Authorization.php">Выход</a></li>
</ul>
<p><strong><h1><center>Страница изменением</center></strong></h1></p>
<center><img src="../../../../materials/images/schoolchild.png" width="100" height="100" ></center>
<?php
$conn_id=new mysqli('mysql', 'user', 'password', 'school') or exit ();
$flag=0;
echo "<table border=0 cellpadding=5 cellspacing=5 align=center>";
echo "<tr align=center valign=middle bgcolor=#2d5787 style='color:#ffffff'><td>id кружок</td><td>Название</td><td>Преподаватель: Фамилия</td><td>Имя</td><td>Отчество</td><td>Цена</td><td>Изменение</td></tr>"; 
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<td><a href='ModificationClub.php?id_club=".$row['id_club']."'>Изменение</a></td>";
	echo "</tr>";
}
echo "</table>"; 
